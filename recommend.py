...
recommend_div = dbc.Container([
    dbc.Row([
        html.Br(),
        dbc.NavItem(html.A(
        dbc.CardImg(src=r"assets/logo_final-01.jpg", style={'width': '450px', 'height': '300px'}, className='my-1'),
        ...
        html.Div(dbc.Badge('Recommendations', color='#EE7066', text_color='black')),
        html.Br(),
        dcc.Loading([
            dbc.Row([
